...
| 框架                                                                                          | 说明               | 版本          | 学习指南                                                           |
|---------------------------------------------------------------------------------------------|------------------|-------------|----------------------------------------------------------------|
| [Spring Boot](https://spring.io/projects/spring-boot)                                       | 应用开发框架           | 3.0.5      | [文档](https://github.com/YunaiV/SpringBoot-Labs)                |
...
| [Spring Boot Admin](https://github.com/codecentric/spring-boot-admin)                       | Spring Boot 监控平台 | 3.0.2      | [文档](http://www.iocoder.cn/Spring-Boot/Admin/?yudao)           |
