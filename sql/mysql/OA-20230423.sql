...
create table `oa_customer` (
  ...
  customer_type     tinyint         default 1                  comment '类型',
...
create table `oa_attendance` (
  ...
  visit_type        tinyint         default 1                  comment '拜访类型',
...
create table `oa_expenses` (
  id                bigint(20)      not null auto_increment    comment 'id',
  expenses_type     tinyint         default 1                  comment '报销类型',
  --  展会会费
...
create table `oa_expenses_detail` (
  ...
  detail_type       tinyint         default 1                  comment '明细类型',
...
create table `oa_product` (
  ...
  product_type      tinyint         default 1                  comment '产品类型',
  ...
  update_time       datetime                                   comment '更新时间',
  tenant_id         bigint          not null default 0         comment '租户编号',
  hot_level         bigint          default 0                  comment '搜索热度',
  primary key (id)
...
create table `oa_contract` (
  ...
  --   1.三锐 2.广州分公司
  company_type      tinyint         default 1                  comment '公司类型',
...
create table `oa_project_impl` (
  ...
  impl_scope        tinyint         default 1                  comment '实施范围',
...
create table `oa_project_impl_log` (
  ...
  impl_status       tinyint         default 1                  comment '工程进度',
  creator           varchar(64)     default ''                 comment '创建者',
  create_time       datetime                                   comment '创建时间',
  updater           varchar(64)     default ''                 comment '更新者',
  update_time       datetime                                   comment '更新时间',
...
create table `oa_opportunity` (
  ...
  status            tinyint         default 1                  comment '商机状态',
  remark            varchar(255)                               comment '备注',
  deleted           bit(1)          not null default b'0'      comment '是否删除',
  creator           varchar(64)     default ''                 comment '创建者',
  create_time       datetime                                  comment '创建时间',
...
create table `oa_quarterly_assessment` (
  id                bigint(20)      not null auto_increment    comment 'id',
  --  1.第一季度 2 3 4.第四季度
  quarter           tinyint         default 1                  comment '季度',
