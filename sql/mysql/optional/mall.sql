...
-- ----------------------------
-- Table structure for promotion_bargain_activity 砍价活动
-- ----------------------------
DROP TABLE IF EXISTS `promotion_bargain_activity`;
CREATE TABLE `promotion_bargain_activity`  (
                                               `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '砍价活动编号',
                                               `spu_id` bigint(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT '关联商品ID',
                                               `bargain_sku_id` bigint(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT '砍价商品表skuID',
                                               `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '砍价活动名称',
                                               `start_time` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '砍价开启时间',
                                               `end_time` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '砍价结束时间',
                                               `status` tinyint(4) UNSIGNED NOT NULL DEFAULT 1 COMMENT '砍价状态 0(关闭)  1(开启)',
                                               `bargain_max_price` int(11) NOT NULL DEFAULT -1 COMMENT '用户每次砍价的最大金额',
                                               `bargain_min_price` int(11) NOT NULL DEFAULT -1 COMMENT '用户每次砍价的最小金额',
                                               `bargain_count` int(11) UNSIGNED NOT NULL DEFAULT 1 COMMENT '用户帮砍的次数',
                                               `sort` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '排序',
                                               `bargain_effective_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '砍价有效时间',
                                               `min_price` decimal(8, 2) UNSIGNED NOT NULL DEFAULT 0.00 COMMENT '砍价商品最低价',
                                               `bargain_first_price` int(11) NOT NULL DEFAULT -1 COMMENT '砍价起始金额',
                                               `stock` int(11) UNSIGNED NOT NULL DEFAULT 1 COMMENT '库存',
                                               `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
...
-- ----------------------------
-- Table structure for promotion_bargain_sku 砍价商品sku
-- ----------------------------
DROP TABLE IF EXISTS `promotion_bargain_sku`;
CREATE TABLE `promotion_bargain_sku`  (
                                          `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
                                          `spu_id` bigint(20) NOT NULL COMMENT 'SPU 名字',
                                          `spu_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '名字',
                                          `price` int(11) NOT NULL DEFAULT -1 COMMENT '销售价格，单位：分',
                                          `market_price` int(11) NULL DEFAULT NULL COMMENT '市场价',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '砍价库存' ROW_FORMAT = Dynamic;
