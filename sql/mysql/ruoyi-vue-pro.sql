...
CREATE TABLE `infra_codegen_column`  (
  ...
  `mock_type` int DEFAULT NULL COMMENT '模拟类型',
  `mock_params` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '模拟参数',
  `default_value` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '默认值',
