...
public interface ErrorCodeConstants {
    ...
    ErrorCode EXECUTION_NOT_EXISTS = new ErrorCode(1009004003, "没有进行中的流程任务");
    ...
    ErrorCode BACK_TASK_NOT_ONE_USER_TASK =
        new ErrorCode(1009005002, "回退任务失败，原因：获取不到该任务的初始任务");
    ErrorCode BACK_TASK_NOT_USER_TASK =
        new ErrorCode(1009005003, "回退任务失败，原因：获取不到该任务的其他任务信息");
    ErrorCode BACK_TASK_NOT_ERROR =
        new ErrorCode(1009005004, "回退任务失败，原因：旧任务信息更新失败");
