...
public class BpmTaskBackReqVO {
    ...
    @Schema(description = "流程编号id", required = true, example = "730da750-cc4f-11ec-b58e-1e429355e4a0")
    @NotEmpty(message = "流程编号id不能为空")
    private String procInstId;

    @Schema(description = "当前任务id", required = true, example = "730da750-cc4f-11ec-b58e-1e429355e4a0")
