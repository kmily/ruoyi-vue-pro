...
@Schema(description = "管理后台 - 医护管理分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class MedicalCarePageReqVO extends PageParam {
    ...
    public String[] status(){
        if(StrUtil.isBlank(status)){
            return new String[]{MedicalCareStatusEnum.OPEN.value(), MedicalCareStatusEnum.CLOSED.value()};
        }else{
            return null;
        }
    }
