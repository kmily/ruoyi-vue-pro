package cn.iocoder.yudao.module.oa.api.user;
...
public interface AppUserApi {
     ...
     * @return 用户数组
     */
    List<AppUserRespDTO> getUserListByDeptIds(Collection<Long> deptIds);
     ...
     * @return 用户数组
     */
    List<AppUserRespDTO> getUsersByPostIds(Collection<Long> postIds);
