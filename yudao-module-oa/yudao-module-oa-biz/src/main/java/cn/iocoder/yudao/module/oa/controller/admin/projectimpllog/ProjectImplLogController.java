package cn.iocoder.yudao.module.oa.controller.admin.projectimpllog;
...
@Tag(name = "管理后台 - 工程日志列表")
@RestController
@RequestMapping("/oa/project-impl-log")
@Validated
public class ProjectImplLogController {
    ...
    @PreAuthorize("@ss.hasPermission('oa:project-impl-log:create')")
    ...
    @PreAuthorize("@ss.hasPermission('oa:project-impl-log:update')")
    ...
    @PreAuthorize("@ss.hasPermission('oa:project-impl-log:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('oa:project-impl-log:query')")
    ...
    @PreAuthorize("@ss.hasPermission('oa:project-impl-log:export')")
