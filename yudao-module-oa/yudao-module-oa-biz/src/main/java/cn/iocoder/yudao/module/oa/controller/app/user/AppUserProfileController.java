package cn.iocoder.yudao.module.oa.controller.app.user;
...
import cn.iocoder.yudao.module.oa.convert.user.UserConvert;
...
public class AppUserProfileController {
    ...
    public CommonResult<AppUserProfileRespVO> profile() {
        ...
        AppUserProfileRespVO resp = UserConvert.INSTANCE.convert03(user);
        // 获得用户角色
