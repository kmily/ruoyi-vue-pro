...
@Schema(description = "管理后台 - 查询商品列新增/修改 Request VO")
@Data
public class YouyouGoodslistSaveReqVO {

    @Schema(description = "商品id", requiredMode = Schema.RequiredMode.REQUIRED, example = "4497")
    private Integer id;
