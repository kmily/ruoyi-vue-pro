package cn.iocoder.yudao.module.steam.dal.dataobject.youyougoodslist;
 ...
 * @author 管理员
 */
@TableName("steam_youyou_goodslist")
@KeySequence("steam_youyou_goodslist_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class YouyouGoodslistDO extends BaseDO {
