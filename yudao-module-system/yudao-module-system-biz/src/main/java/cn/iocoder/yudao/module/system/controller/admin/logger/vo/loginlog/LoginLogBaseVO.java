...
public class LoginLogBaseVO {
    ...
    @Schema(title = "日志类型", requiredMode = Schema.RequiredMode.REQUIRED, example = "1", description = "参见 LoginLogTypeEnum 枚举类")
    ...
    @Schema(title = "用户账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "yudao")
    @NotBlank(message = "用户账号不能为空")
    @Size(max = 30, message = "用户账号长度不能超过30个字符")
    private String username;

    @Schema(title = "登录结果", requiredMode = Schema.RequiredMode.REQUIRED, example = "1", description = "参见 LoginResultEnum 枚举类")
