...
public class OAuth2OpenCheckTokenRespVO {
    ...
    @Schema(title = "租户编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1024")
    @JsonProperty("tenant_id")
    private Long tenantId;

    @Schema(title = "客户端编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "car")
    @JsonProperty("client_id")
    private String clientId;
    @Schema(title = "授权范围", requiredMode = Schema.RequiredMode.REQUIRED, example = "user_info")
    ...
    @Schema(title = "过期时间", requiredMode = Schema.RequiredMode.REQUIRED, example = "1593092157", description = "时间戳 / 1000，即单位：秒")
    private Long exp;
