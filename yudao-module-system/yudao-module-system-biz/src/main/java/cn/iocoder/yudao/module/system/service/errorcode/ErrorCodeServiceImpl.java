...
public class ErrorCodeServiceImpl implements ErrorCodeService {
    ...
    public Long createErrorCode(ErrorCodeCreateReqVO createReqVO) {
        // 校验 code 重复
        validateCodeDuplicate(createReqVO.getCode(), createReqVO.getLangType(),null);
    ...
    public void updateErrorCode(ErrorCodeUpdateReqVO updateReqVO) {
        ...
        // 校验 code 重复
        validateCodeDuplicate(updateReqVO.getCode(), updateReqVO.getLangType(), updateReqVO.getId());
     ...
     */
    @VisibleForTesting
    public void validateCodeDuplicate(Integer code, String langType, Long id) {
        ErrorCodeDO errorCodeDO = errorCodeMapper.selectByCode(code, langType);
        if (errorCodeDO == null) {
            return;
        }
        ...
        autoGenerateDTOs.forEach(autoGenerateDTO -> {
            ...
            if (errorCodeDO == null) {
                errorCodeDO = ErrorCodeConvert.INSTANCE.convert(autoGenerateDTO)
                        ...
                        .setLangType(Locale.SIMPLIFIED_CHINESE.getLanguage());
