...
@Component
public class TreatmentCalendarFlow extends BaseFlow{
    ...
    public TreatmentCalendarFlow(ProcessEngine engine) {
        super(engine);
    }

    public String deploy(Long id, Map<String, Object> settings) {
        return super.deploy(id, "/treatment_calendar_flow.json", settings);
    }

    @Override
    public String getProcessName(Long id) {
        return "TreatmentCalendar-" + id;
    }
