...
export const DICT_TYPE = {
  ...
  // ========== SCAN - PROMOTION 模块 ==========
  SCAN_SYS_TYPE:'scan_sys_type',
  SCAN_APP_AUDIT_STATE:'scan_app_audit_state',
  SCAN_FORCE_UPDATE:'scan_force_update',
  SCAN_APP_STATE:'scan_app_state',
  SCAN_SOLUTION_SUGGEST_TYPE:'scan_solution_suggest_type',
