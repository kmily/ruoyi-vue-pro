    ...
    methods: {
     ...
     async open(id) {
        ...
        if (id) {
          ...
          try {
            const res = await YouyouCommodityApi.getYouyouCommodity(id);
      ...
      async submitForm() {
        ...
        try {
          const data = this.formData;
                  // 修改的提交
          if (data.id) {
            await YouyouCommodityApi.updateYouyouCommodity(data);
          ...
          // 添加的提交
          await YouyouCommodityApi.createYouyouCommodity(data);
